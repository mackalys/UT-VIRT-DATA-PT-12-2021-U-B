Sub GradeBook_2()
  ...
  ElseIf Cells(2, 2).Value >= 70 Then
      ...
      ' Establish that the grade is a Pass
      Cells(2, 3).Value = "Passed"

      ' Color the Warning grade yellow-green RGB.
      Cells(2, 3).Interior.Color = vbGreen

      ' Set the letter grade to "C"
      Cells(2, 4).Value = "C"

   'Check if the student's grade is greater than or equal to 60...
  ElseIf Cells(2, 2).Value >= 60 Then
